<template>
  <section class="max-w-5xl px-5 mx-auto text-center">
    <span class="mt-16 inline-block">#tumbuhbersama</span>
    <h1 class="mt-4 font-bold text-5xl">
    ...
    <img src="images/hero-image.png" alt="Hero Image" class="w-full mt-16">
  </section>
</template>
